 ...
 * @LastEditors: rendc
 * @LastEditTime: 2025-05-01 14:10:25
 */
...
export default function ProseHead({ lang,frontMatter,backLabel,authorLabel }: Props) {
    return (
        <>
            
                <a href={`${getPathname(lang,'/blog')}`} className="flex flex-row items-center gap-2 text-sm  mb-16 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                <svg className="text-current w-3.5 h-3.5" data-testid="geist-icon" fill="none" height="24" shape-rendering="geometricPrecision" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M19 12H5"></path><path d="M12 19l-7-7 7-7"></path></svg>
                    {backLabel}
                </a>
                ...
                <span className="text-sm  mb-16 text-gray-500 dark:text-gray-400">{authorLabel}</span>
